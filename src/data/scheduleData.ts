...
export const SCHEDULE_DATA: ScheduleEvent[] = [
  ...
  { id: 's1-lb', time: 'Lunch Break', title: 'LUNCH BREAK', category: 'Break', stage: '', day: 'Monday 10/08 (Stages)', status: 'Upcoming' },
  { id: 's1-7', time: '02:00 PM', title: 'Bharathanatyam (Cat 1)', category: 'Dance', stage: 'Stage 1: Main Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 7 },
  { id: 's1-8', time: '03:10 PM', title: 'Mohiniyattam (Cat 2)', category: 'Dance', stage: 'Stage 1: Main Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 1 },
  { id: 's1-9', time: '03:20 PM', title: 'Mohiniyattam (Cat 3)', category: 'Dance', stage: 'Stage 1: Main Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 4 },
  { id: 's1-10', time: '04:00 PM', title: 'Folk Dance (Cat 1)', category: 'Dance', stage: 'Stage 1: Main Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 11 },
  { id: 's1-11', time: '05:05 PM', title: 'Folk Dance (Cat 2)', category: 'Dance', stage: 'Stage 1: Main Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 11 },
  { id: 's1-12', time: '06:10 PM', title: 'Folk Dance (Cat 3)', category: 'Dance', stage: 'Stage 1: Main Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 3 },
  ...
  { id: 's2-lb', time: 'Lunch Break', title: 'LUNCH BREAK', category: 'Break', stage: '', day: 'Monday 10/08 (Stages)', status: 'Upcoming' },
  ...
  { id: 's3-lb', time: 'Lunch Break', title: 'LUNCH BREAK', category: 'Break', stage: '', day: 'Monday 10/08 (Stages)', status: 'Upcoming' },
  { id: 's3-7', time: '02:00 PM', title: 'Classical Music (Cat 2 Boys)', category: 'Music', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 2 },
  { id: 's3-8', time: '02:20 PM', title: 'Classical Music (Cat 2 Girls)', category: 'Music', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 2 },
  { id: 's3-9', time: '02:40 PM', title: 'Classical Music (Cat 3 Boys)', category: 'Music', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 3 },
  { id: 's3-10', time: '03:10 PM', title: 'Classical Music (Cat 3 Girls)', category: 'Music', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 5 },
  { id: 's3-11', time: '03:50 PM', title: 'Violin (Cat 3)', category: 'Instrumental', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: '1 Boy, 1 Girl' },
  { id: 's3-12', time: '04:00 PM', title: 'Group Song (House-wise Common)', category: 'House Item', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 4 },
  { id: 's3-13', time: '04:40 PM', title: 'Patriotic Song (House-wise Common)', category: 'House Item', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 4 },
  { id: 's3-14', time: '05:20 PM', title: 'National Anthem (House-wise Common)', category: 'House Item', stage: 'Stage 3: KG Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 4 },
  ...
  { id: 's5-lb', time: 'Lunch Break', title: 'LUNCH BREAK', category: 'Break', stage: '', day: 'Monday 10/08 (Stages)', status: 'Upcoming' },
  { id: 's5-5', time: '02:15 PM', title: 'Malayalam Recitation (Cat 3)', category: 'Malayalam', stage: 'Stage 5: Class IX A', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 12 },
  { id: 's5-6', time: '03:15 PM', title: 'Malayalam Recitation (Cat 4)', category: 'Malayalam', stage: 'Stage 5: Class IX A', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 3 },
  { id: 's5-7', time: '03:30 PM', title: 'Malayalam Extempore (Cat 3)', category: 'Malayalam', stage: 'Stage 5: Class IX A', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 10 },
  { id: 's5-8', time: '04:30 PM', title: 'Sanskrit Recitation (Cat 3)', category: 'Sanskrit', stage: 'Stage 5: Class IX A', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 6 },
  { id: 's5-9', time: '05:00 PM', title: 'Sanskrit Recitation (Cat 4)', category: 'Sanskrit', stage: 'Stage 5: Class IX A', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 1 },
  { id: 's5-10', time: '05:05 PM', title: 'Sanskrit Recitation (Cat 2)', category: 'Sanskrit', stage: 'Stage 5: Class IX A', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 10 },
  ...
  { id: 's6-lb', time: 'Lunch Break', title: 'LUNCH BREAK', category: 'Break', stage: '', day: 'Monday 10/08 (Stages)', status: 'Upcoming' },
  { id: 's6-8', time: '01:30 PM', title: 'Mappilappattu (Cat 4 Girls)', category: 'Music', stage: 'Stage 6: Kids Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 8 },
  { id: 's6-9', time: '02:15 PM', title: 'Arabic Recitation (Cat 4)', category: 'Arabic', stage: 'Stage 6: Kids Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 2 },
  { id: 's6-10', time: '02:30 PM', title: 'Arabic Recitation (Cat 3)', category: 'Arabic', stage: 'Stage 6: Kids Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 4 },
  { id: 's6-11', time: '03:00 PM', title: 'Arabic Recitation (Cat 2)', category: 'Arabic', stage: 'Stage 6: Kids Auditorium', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 3 },
  ...
  { id: 's7-2', time: '09:00 AM', title: 'PPT (Cat 3)', category: 'Computer', stage: 'Stage 7: Computer Lab', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 8 },
  { id: 's7-3', time: '09:00 AM', title: 'PPT (Cat 4)', category: 'Computer', stage: 'Stage 7: Computer Lab', day: 'Monday 10/08 (Stages)', status: 'Upcoming', participants: 4 },
  ...
  { id: 's7-5', time: '12:00 PM', title: 'Digital Painting (Cat 3)', category: 'Computer', stage: 'Stage 7: Computer Lab', day: 'Monday 10/08 (Stages)', status: 'Upcoming' },
  { id: 's7-6', time: '12:00 PM', title: 'Digital Painting (Cat 4)', category: 'Computer', stage: 'Stage 7: Computer Lab', day: 'Monday 10/08 (Stages)', status: 'Upcoming' },
...
export const DAY2_SCHEDULE_DATA: ScheduleEvent[] = [
  // STAGE 2: Mini Auditorium — English ONLY
  ...
  { id: 'd2-s2-4', time: 'Lunch Break', title: 'LUNCH BREAK', category: 'Break', stage: '', day: 'Tuesday 11/08 (Day 2)', status: 'Upcoming' },
